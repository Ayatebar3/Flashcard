  ...
  function Card() {
    ...
    _defineProperty(_assertThisInitialized(_this3), "flipCard", function () {
      ...
      if (user_ans.toLowerCase().trim() == card.english.toLowerCase().trim()) {
        ...
        document.getElementById('cardBack_p_id').classList.add('correct');
...
function (_React$Component7) {
  ...
  function Pages(props) {
    ...
    _defineProperty(_assertThisInitialized(_this5), "getNextCard", function () {
      ...
      document.getElementById('cardBack_p_id').classList.remove('correct'); /////////////////////////
      ...
      if (score >= randomScoreVal) {
        // show card
        document.getElementById("cardFront_p_id").textContent = card.translation; // update cardObject
